...
```bash
bash <(curl -Ls [https://raw.githubusercontent.com/FalconDNS/RaiseTunnel/main/install.sh](https://raw.githubusercontent.com/FalconDNS/RaiseTunnel/main/install.sh))
